export function useItemTargetedAgeMonths<
	T extends { targeted_age_months: string },
>(
	...
	const targetedAgeMonths = computed(() =>
		string2range(toValue(item).targeted_age_months),
	);
